...
interface CosmicParallaxBgProps {
  ...
  /**
   * Whether to show the head and text content inside the component
   * @default true
   */
  showContent?: boolean;
}
...
const CosmicParallaxBg: React.FC<CosmicParallaxBgProps> = ({
  ...
  return (
    <div className={`cosmic-parallax-container ${className}`}>
      ...
      {/* Horizon and Earth */}
      <div id="horizon" className="opacity-20">
      ...
      {showContent && (
        <>
          <div id="title" className="font-display !font-light tracking-[0.2em]">{head.toUpperCase()}</div>
          <div id="subtitle" className="font-body !font-extralight tracking-[0.5em] opacity-60">
